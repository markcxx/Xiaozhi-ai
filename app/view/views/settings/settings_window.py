...
from app.view.views.settings.components.shortcuts_settings import ShortcutsSettingsWidget
from app.view.views.settings.components.system_options import SystemOptionsWidget
from app.view.views.settings.components.wake_word import WakeWordWidget
from app.view.views.settings.components.camera import CameraWidget
from app.view.views.settings.components.audio import AudioWidget
